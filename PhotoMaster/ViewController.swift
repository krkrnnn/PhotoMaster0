...
class ViewController: UIViewController, UINavigationControllerDelegate, UIImagePickerControllerDelegate {
    ...
    func drawText(image: UIImage) -> UIImage {
        ...
        //描き出す位置と大きさの設定
        //CGRectMake([左からのx座標]px, [上からのy座標]px, [縦の長さ]px, [横の長さ]px)
    ...
    func drawMaskImage(image: UIImage) -> UIImage {
        ...
        let maskImage = UIImage(named: "cat")
        ...
        //maskRectで指摘した範囲にmaskImageを描き出す
    ...
    @IBAction func processButtonTapped(sender: UIButton){
        ...
        let secondAction = UIAlertAction(title: "ネコマーク", style: .Default){
            action in
            
            //selectedPhotoに画像を合成して描き出す
